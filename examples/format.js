global.base2 = {
  ...
  version: "1.0",
  exports:
    "Base,Package,Abstract,Module,Enumerable,Map,Collection,RegGrp,Undefined,Null,This,True,False,assignID,detect,global",
  namespace: "",
};
new (function (_y) {
  var Undefined = K(),
  ...
  var Package = Base.extend({
      ...
      if (e) {
        ...
        e.imports =
          Array2.reduce(
            ...
            "var base2=(function(){return this.base2})();" + base2.namespace + f
          ) + lang.namespace;
        e.exports =
          Array2.reduce(
            csv(this.exports),
    ...
    toString: function () {
      return format(
        "[%1]",
        this.parent
          ? String2.slice(this.parent, 1, -1) + "." + this.name
          : this.name
      );
    },
  });
  ...
  var Module = Abstract.extend(null, {
    ...
    partial: function () {
      ...
      c.namespace = this.namespace.replace(
        /(\w+)=b[^\)]+\)/g,
        "$1=" + e + ".$1"
      );
  ...
  var Map = Base.extend({
    ...
    has: function (a) {
      /*@cc_on @*/ /*@if(@_jscript_version<5.5)return $Legacy.has(this,_1+a);@else @*/ return (
        _1 + a in this
      ); /*@end @*/
    },
    merge: function (b) {
          ...
          if (typeof b == "string" && _t.test(b)) {
            if (_u.test(b)) {
              ...
              b = b
                ...
                .replace(/\n/g, "\\n")
                .replace(/\r/g, "\\r")
                .replace(/\$(\d+)/g, c + "+(arguments[$1]||" + c + c + ")+" + c)
                .replace(/(['"])\1\+(.*)\+\1\1$/, "$1");
  ...
  var lang = {
    ...
    exports:
      "assert,assertArity,assertType,base,bind,copy,extend,forEach,format,instanceOf,match,pcopy,rescape,trim,typeOf",
    namespace: "",
  };
  ...
  function _e(a, b, c) {
    ...
    if (typeof a == "string") {
      ...
      for (d = 0; d < e; d++) {
        /*@cc_on @*/ /*@if(@_jscript_version<5.2)if($Legacy.has(a,d))@else @*/ if (
          d in a
        )
          /*@end @*/ b.call(c, a[d], d, a);
      }
    }
  }
  function _5(g, i, h, j) {
  ...
  function instanceOf(a, b) {
    ...
    /*@cc_on if(typeof a.constructor!="function"){return typeOf(a)==typeof b.prototype.valueOf()}@*/ if (
      a.constructor == b
    )
      return true;
    if (b.ancestorOf) return b.ancestorOf(a.constructor);
    /*@if(@_jscript_version<5.1)@else @*/ if (a instanceof b) return true;
      ...
      case "object":
        return a == null
          ...
          ? _j.test(a)
            ? "function"
            : b
          : typeof a.constructor.prototype.valueOf();
      case "function":
  ...
  function _6(b, c, e, d) {
    ...
    i.ancestor = Object;
    delete i.extend;
    i.namespace = i.namespace.replace(
      /(var (\w+)=)[^,;]+,([^\)]+)\)/g,
      "$1$3.$2"
    );
    return i;
  ...
  var _3 = { Hectomicroseconds: 15, UTC: 16, Sign: 17, Hours: 18, Minutes: 20 };
  var _w = /(((00)?:0+)?:0+)?\.0+$/;
  var _x = /(T[0-9:.]+)$/;
  var Date2 = _6(
    Date,
  ...
  function detect() {
    var d = NaN;
    /*@cc_on||@_jscript_version@*/ var f = global.java ? true : false;
    if (global.navigator) {
      var g = /MSIE[\d.]+/g;
    ...
    detect = function (a) {
      if (j[a] == null) {
        ...
        if (c.charAt(0) == "(") {
          try {
            b = new Function("element,jscript,java,global", "return !!" + c)(
              i,
              d,
              f,
              global
...
new (function () {
  ...
  var w = v.extend(
    ...
    {
      IGNORE: { CONDITIONAL: i, "(OPERATOR)(REGEXP)": i },
  ...
  var q = v.extend(
    ...
    },
    {
      ...
      UNPACK:
        "eval(function(p,a,c,k,e,r){e=%5;if('0'.replace(0,e)==0){while(c--)r[e(c)]=k[c];k=[function(e){return r[e]||e}];e=function(){return'%6'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\\\b'+e(c)+'\\\\b','g'),k[c]);return p}('%1',%2,%3,'%4'.split('|'),0,{}))",
    }
  );
  global.Packer = Base.extend(
    ...
    },
    {
      ...
      encode52: function (c) {
        function d(a) {
          return (
            (a < 52 ? "" : d(parseInt(a / 52))) +
            ((a = a % 52) > 25
              ? String.fromCharCode(a + 39)
